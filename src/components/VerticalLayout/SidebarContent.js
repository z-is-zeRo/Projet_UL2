          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                {/* <li>
                  <Link to="/dashboard2">{props.t("Dashboard")} 2</Link>
                </li> */}
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/projects-list">{props.t("Project List")}</Link>
                </li>
                <li>
                  <Link to="/projects-kanban">{props.t("Kanban Board")}</Link>
                </li>
                <li>
                  <Link to="/projects-create">{props.t("Create Project")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Milestones")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/milestones-list">{props.t("Milestone List")}</Link>
                </li>
                <li>
                  <Link to="/milestones-kanban">{props.t("Kanban Board")}</Link>
                </li>
                <li>
                  <Link to="/milestones-create">
                    {props.t("Create Milestone")}
                  </Link>
                </li>
              </ul>
            </li>
