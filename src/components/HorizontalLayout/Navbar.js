                ...
                <div className={classname("dropdown-menu", { show: app })}>
                  ...
                  <div className="dropdown">
                    ...
                    >
                      ...
                      <Link to="/projects-kanban" className="dropdown-item">
                  ...
                  <div className="dropdown">
                    ...
                    >
                      {props.t("Milestones")} <div className="arrow-down"></div>
                    </Link>
                    <div
                    ...
                    >
                      <Link to="/milestones-list" className="dropdown-item">
                        {props.t("Milestone List")}
                      </Link>
                      <Link to="/milestones-kanban" className="dropdown-item">
                        {props.t("Kanban Board")}
                      </Link>
                      <Link to="/milestones-create" className="dropdown-item">
